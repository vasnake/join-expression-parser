#  Copyright (c) 2020-2022, vasnake@gmail.com
#
#  Licensed under GNU General Public License v3.0 (see LICENSE)
#

"""
Simple parser + evaluator demo for infix operations w/o precedence.
If you need precedence use parenthesis.

Alternative implementation could be as
parser for infix expressions, based on stacks.
